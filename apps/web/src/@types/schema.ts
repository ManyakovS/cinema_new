...
export const ticketBuy = (body: BookTicketsDTO, options?: any) =>
  request<TicketResource[]>("/ticket/buy", {
    body,
    method: "POST",
    ...options,
  });
...
export const authRequest = (options?: any) =>
  request<AuthResource>("/auth/refresh", { method: "GET", ...options });
...
/* Админ */
/* Создать фильм */
export const adminCreateFilm = (body: FullCreateFilm, options?: any) =>
  request<FilmResource>("/films/fullCreate", {
    body,
    method: "POST",
    ...options,
  });
...
/* Получить актеров */
export const actorsRequest = (params: GetActorsParamsDTO, options?: any) =>
  request<Actor[]>("/actor", { method: "GET", ...options, params });
