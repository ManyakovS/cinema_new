    ...
    for (const [film] of __VLS_getVForSourceType((__VLS_ctx.films))) {
        ...
        if (film) {
            ...
            __VLS_elementAsFunction(__VLS_intrinsicElements.template, __VLS_intrinsicElements.template)({});
            {
                ...
                [BaseButton,];
                const __VLS_19 = __VLS_asFunctionalComponent(__VLS_18, new __VLS_18({ ...{ class: ("w-full") }, label: ("Завершено"), disabled: (true), }));
                const __VLS_20 = __VLS_19({ ...{ class: ("w-full") }, label: ("Завершено"), disabled: (true), }, ...__VLS_functionalComponentArgsRest(__VLS_19));
                ({}({ ...{ class: ("w-full") }, label: ("Завершено"), disabled: (true), }));
                [itemPage, films,];
...
;
//# sourceMappingURL=TicketsDone.vue.js.map