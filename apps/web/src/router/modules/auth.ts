...
export const routes: RouteRecordRaw[] = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        path: "register",
        component: () =>
          import("@/pages/auth/components/auth-forms/register/Register.vue"),
        beforeEnter: isAuthicatedGuard,
        ...
        children: [
          {
            ...
            component: () =>
              import(
                "@/pages/auth/components/auth-forms/register/children/RegisterVerifyEmail.vue"
              ),
            beforeEnter: isAuthicatedGuard,
          },
          {
            ...
            component: () =>
              import(
                "@/pages/auth/components/auth-forms/register/children/RegistrerVerifyCode.vue"
              ),
            beforeEnter: isAuthicatedGuard,
          },
          {
            ...
            component: () =>
              import(
                "@/pages/auth/components/auth-forms/register/children/RegisterMainForm.vue"
              ),
            beforeEnter: isAuthicatedGuard,
          },
        ],
      },
      {
        ...
        path: "restore",
        component: () =>
          import("@/pages/auth/components/auth-forms/Restore.vue"),
        beforeEnter: isAuthicatedGuard,
      },
      {
        ...
        component: () =>
          import("@/pages/auth/components/auth-forms/RestorePassword.vue"),
