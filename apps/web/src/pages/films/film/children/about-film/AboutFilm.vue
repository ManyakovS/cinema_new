<template>
  <div v-if="film" class="about-film d-flex flex-column h-full">
    ...
    <ButtonBack :to="{ name: 'films-list' }" />
    <BaseShareButton />

    <div class="d-flex flex-column about-film__content mt-auto justify-between">
      <!-- <div>Back</div>
      <div>Share</div> -->

      <div>
        <div class="mt-5">INFO CARD</div>
        ...
        <div class="mt-5">BOOK NOW BTN</div>
      </div>

      <!-- <BaseFixedButton label="Купить" :to="{ name: 'film-dating' }" /> -->
